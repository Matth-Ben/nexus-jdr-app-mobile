...
import 'package:personnages/features/characters/domain/gallery_photo_storage_path_resolver.dart';

void main() {
  group('GalleryPhotoStoragePathResolver.resolve', () {
    test('extrait le chemin depuis une URL publique Supabase Storage', () {
      const url =
          'http://127.0.0.1:54321/storage/v1/object/public/'
          'character-gallery-photos/abc/def/123456.png';
      expect(
        GalleryPhotoStoragePathResolver.resolve(url),
        'abc/def/123456.png',
      );
    });
    ...
    test('fonctionne avec un domaine de production https', () {
      const url =
          ...
          'character-gallery-photos/owner-1/char-2/999.png';
      expect(
        GalleryPhotoStoragePathResolver.resolve(url),
    ...
    test('retourne null si le chemin après le marqueur est vide', () {
      const url =
          ...
          'character-gallery-photos/';
      expect(GalleryPhotoStoragePathResolver.resolve(url), isNull);
    });
  });
}
