...
@override
String toString() {
  return 'CharacterCreationDraft(raceId: $raceId, subraceId: $subraceId, raceCustomText: $raceCustomText, classId: $classId, subclassId: $subclassId, backgroundId: $backgroundId, abilityScoreMethod: $abilityScoreMethod, abilityScores: $abilityScores, classSkillChoices: $classSkillChoices, classToolChoices: $classToolChoices, backgroundLanguageChoices: $backgroundLanguageChoices, classCantripChoices: $classCantripChoices, classLevelOneSpellChoices: $classLevelOneSpellChoices, equipmentChoiceTab: $equipmentChoiceTab, purchasedEquipment: $purchasedEquipment, appearanceText: $appearanceText, traitsText: $traitsText, idealsText: $idealsText, bondsText: $bondsText, flawsText: $flawsText, backstoryText: $backstoryText, alliesText: $alliesText, featuresText: $featuresText, treasureText: $treasureText, characterName: $characterName, portraitBytes: $portraitBytes)';
}
