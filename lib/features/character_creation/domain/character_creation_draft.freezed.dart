...
/// `domain/class_catalog.dart`).
 int? get classId;/// Sous-classe choisie à l'étape 2 (`subclasses.id`), uniquement pour les
...
/// pour toutes les autres classes ou tant que rien n'est choisi.
 int? get subclassId;/// Historique choisi à l'étape 3, `null` si pas encore choisi. Pas
...
/// destinées aux colonnes `characters.appearance_text`/`traits_text`/...
 String? get appearanceText;/// Identité physique saisie à l'étape 8 (champs courts, texte libre) —
/// colonnes `characters.sexe`/`age`/`height`/`weight`/`eyes`/`skin`/
/// `hair`, toutes `text` nullables. `null` = jamais renseigné.
 String? get sexe;/// Voir [sexe] — `characters.age`.
 String? get age;/// Voir [sexe] — `characters.height`.
 String? get height;/// Voir [sexe] — `characters.weight`.
 String? get weight;/// Voir [sexe] — `characters.eyes`.
 String? get eyes;/// Voir [sexe] — `characters.skin`.
 String? get skin;/// Voir [sexe] — `characters.hair`.
 String? get hair;/// Voir [appearanceText] — `characters.traits_text`.
 ...
 String? get treasureText;/// Nom du personnage, saisi à l'étape 9 "Récapitulatif" (`characters
...
/// seule `presentation/summary_step_screen.dart` le lit/l'écrit.
 String? get characterName;/// Portrait choisi et recadré à l'étape 8 (PNG carré, sortie de
...
/// fois son identifiant connu (voir `summary_step_screen.dart`).
 Uint8List? get portraitBytes;/// Alignement choisi à l'étape 8 (`characters.alignment_id`), `null` si
/// aucun.
 int? get alignmentId;
...
@useResult
$Res call({
 int? raceId, int? subraceId, String? raceCustomText, int? classId, int? subclassId, int? backgroundId, AbilityScoreMethod? abilityScoreMethod, Map<String, int>? abilityScores, List<String> classSkillChoices, List<String> classToolChoices, List<String> backgroundLanguageChoices, List<String> classCantripChoices, List<String> classLevelOneSpellChoices, EquipmentChoiceTab? equipmentChoiceTab, Map<String, int> purchasedEquipment, String? appearanceText, String? sexe, String? age, String? height, String? weight, String? eyes, String? skin, String? hair, String? traitsText, String? idealsText, String? bondsText, String? flawsText, String? backstoryText, String? alliesText, String? featuresText, String? treasureText, String? characterName, Uint8List? portraitBytes, int? alignmentId
});
...
/// Create a copy of CharacterCreationDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? raceId = freezed,Object? subraceId = freezed,Object? raceCustomText = freezed,Object? classId = freezed,Object? subclassId = freezed,Object? backgroundId = freezed,Object? abilityScoreMethod = freezed,Object? abilityScores = freezed,Object? classSkillChoices = null,Object? classToolChoices = null,Object? backgroundLanguageChoices = null,Object? classCantripChoices = null,Object? classLevelOneSpellChoices = null,Object? equipmentChoiceTab = freezed,Object? purchasedEquipment = null,Object? appearanceText = freezed,Object? sexe = freezed,Object? age = freezed,Object? height = freezed,Object? weight = freezed,Object? eyes = freezed,Object? skin = freezed,Object? hair = freezed,Object? traitsText = freezed,Object? idealsText = freezed,Object? bondsText = freezed,Object? flawsText = freezed,Object? backstoryText = freezed,Object? alliesText = freezed,Object? featuresText = freezed,Object? treasureText = freezed,Object? characterName = freezed,Object? portraitBytes = freezed,Object? alignmentId = freezed,}) {
...
as int?,subclassId: freezed == subclassId ? _self.subclassId : subclassId // ignore: cast_nullable_to_non_nullable
...
as String?,eyes: freezed == eyes ? _self.eyes : eyes // ignore: cast_nullable_to_non_nullable
...
as String?,portraitBytes: freezed == portraitBytes ? _self.portraitBytes : portraitBytes // ignore: cast_nullable_to_non_nullable
as Uint8List?,alignmentId: freezed == alignmentId ? _self.alignmentId : alignmentId // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? raceId,  int? subraceId,  String? raceCustomText,  int? classId,  int? subclassId,  int? backgroundId,  AbilityScoreMethod? abilityScoreMethod,  Map<String, int>? abilityScores,  List<String> classSkillChoices,  List<String> classToolChoices,  List<String> backgroundLanguageChoices,  List<String> classCantripChoices,  List<String> classLevelOneSpellChoices,  EquipmentChoiceTab? equipmentChoiceTab,  Map<String, int> purchasedEquipment,  String? appearanceText,  String? sexe,  String? age,  String? height,  String? weight,  String? eyes,  String? skin,  String? hair,  String? traitsText,  String? idealsText,  String? bondsText,  String? flawsText,  String? backstoryText,  String? alliesText,  String? featuresText,  String? treasureText,  String? characterName,  Uint8List? portraitBytes,  int? alignmentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CharacterCreationDraft() when $default != null:
return $default(_that.raceId,_that.subraceId,_that.raceCustomText,_that.classId,_that.subclassId,_that.backgroundId,_that.abilityScoreMethod,_that.abilityScores,_that.classSkillChoices,_that.classToolChoices,_that.backgroundLanguageChoices,_that.classCantripChoices,_that.classLevelOneSpellChoices,_that.equipmentChoiceTab,_that.purchasedEquipment,_that.appearanceText,_that.sexe,_that.age,_that.height,_that.weight,_that.eyes,_that.skin,_that.hair,_that.traitsText,_that.idealsText,_that.bondsText,_that.flawsText,_that.backstoryText,_that.alliesText,_that.featuresText,_that.treasureText,_that.characterName,_that.portraitBytes,_that.alignmentId);case _:
  return orElse();
...
class _CharacterCreationDraft implements CharacterCreationDraft {
  const _CharacterCreationDraft({this.raceId, this.subraceId, this.raceCustomText, this.classId, this.subclassId, this.backgroundId, this.abilityScoreMethod,  Map<String, int>? abilityScores,  List<String> classSkillChoices = const <String>[],  List<String> classToolChoices = const <String>[],  List<String> backgroundLanguageChoices = const <String>[],  List<String> classCantripChoices = const <String>[],  List<String> classLevelOneSpellChoices = const <String>[], this.equipmentChoiceTab,  Map<String, int> purchasedEquipment = const <String, int>{}, this.appearanceText, this.sexe, this.age, this.height, this.weight, this.eyes, this.skin, this.hair, this.traitsText, this.idealsText, this.bondsText, this.flawsText, this.backstoryText, this.alliesText, this.featuresText, this.treasureText, this.characterName, this.portraitBytes, this.alignmentId}): _abilityScores = abilityScores,_classSkillChoices = classSkillChoices,_classToolChoices = classToolChoices,_backgroundLanguageChoices = backgroundLanguageChoices,_classCantripChoices = classCantripChoices,_classLevelOneSpellChoices = classLevelOneSpellChoices,_purchasedEquipment = purchasedEquipment;
...
/// dans Storage juste après la création du personnage à l'étape 9, une
/// fois son identifiant connu (voir `summary_step_screen.dart`).
@override final  Uint8List? portraitBytes;
/// Alignement choisi à l'étape 8 (`characters.alignment_id`), `null` si
/// aucun.
@override final  int? alignmentId;
...
@override
int get hashCode => Object.hashAll([runtimeType,raceId,subraceId,raceCustomText,classId,subclassId,backgroundId,abilityScoreMethod,const DeepCollectionEquality().hash(_abilityScores),const DeepCollectionEquality().hash(_classSkillChoices),const DeepCollectionEquality().hash(_classToolChoices),const DeepCollectionEquality().hash(_backgroundLanguageChoices),const DeepCollectionEquality().hash(_classCantripChoices),const DeepCollectionEquality().hash(_classLevelOneSpellChoices),equipmentChoiceTab,const DeepCollectionEquality().hash(_purchasedEquipment),appearanceText,sexe,age,height,weight,eyes,skin,hair,traitsText,idealsText,bondsText,flawsText,backstoryText,alliesText,featuresText,treasureText,characterName,const DeepCollectionEquality().hash(portraitBytes),alignmentId]);
...
/// Create a copy of CharacterCreationDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? raceId = freezed,Object? subraceId = freezed,Object? raceCustomText = freezed,Object? classId = freezed,Object? subclassId = freezed,Object? backgroundId = freezed,Object? abilityScoreMethod = freezed,Object? abilityScores = freezed,Object? classSkillChoices = null,Object? classToolChoices = null,Object? backgroundLanguageChoices = null,Object? classCantripChoices = null,Object? classLevelOneSpellChoices = null,Object? equipmentChoiceTab = freezed,Object? purchasedEquipment = null,Object? appearanceText = freezed,Object? sexe = freezed,Object? age = freezed,Object? height = freezed,Object? weight = freezed,Object? eyes = freezed,Object? skin = freezed,Object? hair = freezed,Object? traitsText = freezed,Object? idealsText = freezed,Object? bondsText = freezed,Object? flawsText = freezed,Object? backstoryText = freezed,Object? alliesText = freezed,Object? featuresText = freezed,Object? treasureText = freezed,Object? characterName = freezed,Object? portraitBytes = freezed,Object? alignmentId = freezed,}) {
