...
/// Occultiste, Rôdeur), plus les sorts mineurs des lanceurs à préparation
/// (Clerc, Druide, Magicien) et le grimoire du Magicien (ajoutés le
/// 2026-09-24) — contenu fourni par le chef de projet, vérifié via
...
abstract final class SpellsKnownProgression {
  ...
  static const Map<String, Map<int, int>> cantripsKnownByLevel = {
    ...
    // Lanceurs à préparation (demande utilisateur, 2026-09-24) : pas de
    // sorts "connus", mais des sorts mineurs gagnés aux niveaux 4 et 10 —
    // valeurs de niveau 1 identiques à `SpellcastingRules.cantripQuotaFor`.
    'Clerc': {
      1: 3,
      2: 3,
      3: 3,
  ...
  static const Map<String, Map<int, int>> spellsKnownByLevel = {
    ...
    // Grimoire du Magicien : 6 sorts au niveau 1 (même valeur que
    // `SpellcastingRules.levelOneSpellQuotaFor`), puis 2 de plus par niveau.
    'Magicien': {
      1: 6,
      2: 8,
      3: 10,
