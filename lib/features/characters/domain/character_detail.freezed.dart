...
/// "invocation"), jamais relues par `fetchCharacterDetail`.
 List<String> get knownInvocationNames;/// Monnaie du personnage (`characters.currency_gp/pp/ep/sp/cp`) — onglet
...
as List<String>,currencyGp: null == currencyGp ? _self.currencyGp : currencyGp // ignore: cast_nullable_to_non_nullable
