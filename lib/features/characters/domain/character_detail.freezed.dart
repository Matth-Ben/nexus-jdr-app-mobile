...
/// `translations`), voir `SupabaseCharacterRepository._fetchInventory`.
 List<CharacterInventoryItem> get inventory;/// Les 9 champs de texte libre de l'onglet "Histoire" — voir
...
as List<CharacterInventoryItem>,appearanceText: null == appearanceText ? _self.appearanceText : appearanceText // ignore: cast_nullable_to_non_nullable
